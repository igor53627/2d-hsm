...
`anchor=[0xa3;32]`, `fleet=[0xf5;32]`) are constructed as:
...
`fleet_scope_id=[0xf5;32]` (25-2a-rev7: was [0xf1;32] — the keystore test fixture; decode_config_map now rejects it per AC#7 anti-hardcoding, so the golden uses a non-fixture value).
