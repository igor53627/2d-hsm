...
| **TASK-7** | In progress | Agent Gateway secp256k1 signer — **7.1+7.2+7.3 merged** (#28 protocol/opcodes + domain separation + golden vectors; #29 sealed keystore + ML-KEM DR-backup format; #30 keygen + public identity); **7.4 (structured transfer/faucet signing) in progress (#31)**. Design: `backlog/docs/agent-gateway-secp256k1-signer-design.md`, `…-keystore-backup-format.md`, `…-keygen-identity.md`, `…-transfer-faucet-signing.md` |
