...
| **TASK-7** | In progress | Agent Gateway secp256k1 signer — **7.1 merged** (#28: protocol opcodes, domain separation, golden vectors); 7.2 (keystore + backup/DR) next. Design: `backlog/docs/agent-gateway-secp256k1-signer-design.md` |
