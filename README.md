...
| **TASK-7** | In progress | Agent Gateway secp256k1 signer — **7.1+7.2 merged** (#28 protocol/opcodes + domain separation + golden vectors; #29 sealed keystore + ML-KEM DR-backup format); **7.3 (keygen + public identity) next**. Design: `backlog/docs/agent-gateway-secp256k1-signer-design.md`, `…-keystore-backup-format.md` |
